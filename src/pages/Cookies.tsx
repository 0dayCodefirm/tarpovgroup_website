...
const sections = [
  ...
  },
  {
    ...
    body: (
      <p>
        Съгласно Регламент (ЕС) 2016/679 (GDPR) имате право на достъп, корекция и изтриване на данните, свързани с Вас. За всички въпроси относно бисквитките и личните данни можете да се свържете с нас на tarpovgroup@gmail.com.
      </p>
    ),
  },
];
