...
const stats = [
  { icon: TrendingDown, value: '60%', label: 'по-енергоефективни', sub: 'спрямо традиционни LED екрани', color: 'bg-brand-cyan/10 text-brand-cyan-dark' },
  { icon: Zap, value: '240 W', label: 'средна консумация', sub: 'при P6.25 панели', color: 'bg-brand-emerald/10 text-brand-emerald-dark' },
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                До{' '}
                <span className="text-gradient-cyan">60% по-енергоефективни</span>{' '}
          ...
          >
            <div className="bg-white rounded-2xl border border-surface-border p-8 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
              ...
              {/* Stacked bar chart — blue on top, grey full-width below */}
              <div className="space-y-5">
                {/* Row 1: Transparent LED — 240 W/m² (blue) inside a full-width light-grey track, animating 0% -> 40% */}
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-heading font-semibold text-ink-secondary">
                      Прозрачен LED
                    </span>
                    <span className="text-sm font-heading font-bold" style={{ color: '#0099CC' }}>240 W/м²</span>
                  </div>
                  <div
                  ...
                  >
                    <motion.div
                      className="relative h-full rounded-xl flex items-center overflow-hidden"
                      style={{
                        width: '45%',
                ...
                {/* Row 2: Traditional LED — 600 W/m² (grey gradient: grey left -> white right) */}
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-heading font-semibold text-ink-secondary">
                      Традиционен LED
                    </span>
                    <span className="text-sm font-heading font-bold text-ink-muted">600 W/м²</span>
                  </div>
                  <motion.div
                    className="relative h-12 rounded-xl flex items-center overflow-hidden"
                    style={{
                      background: 'linear-gradient(90deg, #475569 0%, #64748B 35%, #94A3B8 65%, #CBD5E1 100%)',
                    }}
                ...
                <div className="flex flex-wrap items-center gap-x-5 gap-y-2 pt-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-heading font-semibold" style={{ color: '#0099CC' }}>Прозрачен LED — 240 W/м²</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div
                      className="w-3 h-3 rounded-sm"
                      style={{ background: 'linear-gradient(90deg, #94A3B8 0%, #CBD5E1 60%, #FFFFFF 100%)' }}
                    />
                    <span className="text-xs text-ink-muted">Традиционен LED — 600 W/м²</span>
                  </div>
                </div>
